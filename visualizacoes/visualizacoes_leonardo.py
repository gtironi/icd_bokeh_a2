...
plot_1_leonardo = visualizacao_1_leonardo('visualizacoes/data/spotify_youtube_year.csv')
...
plot_2_leonardo = visualizacao_2_leonardo('visualizacoes/data/spotify_youtube_year.csv')
...
plot_3_leonardo = visualizacao_3_leonardo('visualizacoes/data/spotify_youtube_year.csv')

# Apresentação das análises 
def cria_explicacoes():
    text_1 = Div(text = """
...
def gera_layout_leonardo(datapath):
    """ Gera o layout das visualizações"""
    plot_1_leonardo = visualizacao_1_leonardo(datapath)
    plot_2_leonardo = visualizacao_2_leonardo(datapath)
    plot_3_leonardo = visualizacao_3_leonardo(datapath)

    # Gerando os texts
    text_1 = cria_explicacoes()[0]
    text_2 = cria_explicacoes()[1]
    text_3 = cria_explicacoes()[2]
    text_4 = cria_explicacoes()[3]
...
plotagem = gera_layout_leonardo('visualizacoes/data/spotify_youtube_year.csv')
