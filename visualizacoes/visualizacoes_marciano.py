...
plot_2 = figure(width=600, height = 600, x_range = [2001, 2021]) # Criando a figura do gráfico 2
...
select_years_tool.overlay.fill_alpha = 0.2     # Transparência da barra de rolagem
...
show(column(plot_2, select_years))
